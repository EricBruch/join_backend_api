...
class Task(models.Model):
    ...
    due_date = models.DateField(default=(now() + relativedelta(months=+3)))
    created_at = models.DateField(default=now())
    ...
    status = models.CharField(
        choices=Status.choices, max_length=20, default=Status.BACKLOG
    )
...
# can be one to Many relationship
